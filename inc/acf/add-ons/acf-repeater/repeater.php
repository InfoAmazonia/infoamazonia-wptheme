...
class acf_field_repeater extends acf_field
{
	...
	*/
	...
	function __construct()
	{
    	...
    	// settings
		$this->settings = array(
			'path' => apply_filters('acf/add-ons/repeater/get_path', apply_filters('acf/helpers/get_path', __FILE__)),
			'dir' => apply_filters('acf/add-ons/repeater/get_dir', apply_filters('acf/helpers/get_dir', __FILE__)),
			'version' => '1.0.1'
		);
